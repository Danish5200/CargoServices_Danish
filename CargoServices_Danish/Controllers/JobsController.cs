...
using CargoServices_Danish.Data;
using CargoServices_Danish.Models;
using Microsoft.AspNetCore.Authorization;

namespace CargoServices_Danish.Controllers
{
    [Authorize]
    public class JobsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["VehicleID"] = new SelectList(_context.Vehicles, "ID", "VehicleNo");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,CustomerID,DriverID,VehicleID,StartDate,EndDate,Status")] Job job)
        {
            ...
            ViewData["CustomerID"] = new SelectList(_context.Customers, "ID", "Name", job.CustomerID);
            ViewData["DriverID"] = new SelectList(_context.Drivers, "ID", "Name", job.DriverID);
            ViewData["VehicleID"] = new SelectList(_context.Vehicles, "ID", "VehicleNo", job.VehicleID);
            return View(job);
        }
